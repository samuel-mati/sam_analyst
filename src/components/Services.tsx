...
const services = [
  ...
  },
  {
    ...
    description: 'Leverage cutting-edge AI algorithms to uncover patterns and predict trends.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Web Scraping',
    description: 'Automated data collection from any web source with our advanced scraping tools.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Create stunning, interactive visualizations that tell your data story.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Understand your customers better with advanced analytics and segmentation.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white group-hover:text-white transition-colors duration-300">
                {service.title}
              </h3>
